/**
 * Epic simulator. FHIR R4 over the shared
...
export async function simEpic(
  ...
  return json(
    {resourceType: "OperationOutcome", issue: [{severity: "error", code: "not-supported", diagnostics: `Simulated Epic does not implement: ${method} ${path}`}]},
    501,
  );
}
